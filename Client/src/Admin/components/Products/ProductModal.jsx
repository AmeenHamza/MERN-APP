...
function ProductModal({ getProducts }) {
            ...
            >
                ...
                <Modal.Body>
                    <form className="Product-form" onSubmit={handleSubmit}>
                        <p className="Product-form-title">Add Products</p>
                            ...
                            >
                                <option>Select Category</option>
                                {
                                    categories?.map((value) => (
                                        <option key={value.id}>{value.CategoryName}</option>
                                    ))
                                }
                            </Form.Select>
                        </div>
